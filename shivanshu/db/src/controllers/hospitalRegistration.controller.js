...
const registerHospital = asyncHandler(async (req, res) => {
    ...
    const existedUser = await Hospital.findOne({
        email
    })
    ...
    const createdUser = await Hospital.findById(user._id).select(
...
const logoutHospital = asyncHandler(async (req, res) => {
    Hospital.findByIdAndUpdate(req.user._id,
        {
            $set: {
...
const refreshAccessTokenHs = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const user = await Hospital.findById(decodedToken?._id)
...
const getCurrentUserHs = asyncHandler(async (req, res) => {
    return res
    .status(200)
